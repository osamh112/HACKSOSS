...
echo "";
echo -e "\e[1;34m[*] \e[32m WELCOME IN MY TOOLS BY THE KING OF HACKSOSS NOW PEASE WITE.......\e[0m";
echo "";
...
if [ -e $PREFIX/share/figlet/Remo773.flf ]; then
	echo -e "\e[1;34m[*] \033[32m BY @KY_112 \033[0m";
	sleep 4
else
...
clear;
echo -e "\033[01;32m
programmer osamh fadel @KY_112 (HACKSOSS)
		
	THE KING OF HACKSOSS
+---------------------------*/
.......Terminal-Osamh fadel......
+---------------------------*/
my users :@KY_112 my ch: @V00_8....
\033[0m";
ok=0
while [ $ok = 0 ];
do
	echo ""
tput setaf 3
read -p "Pleas enter your name  : " PROC
tput sgr 0
if [[ ${#PROC} -gt 8 ]]; then
...
bash ~/OSAMH/.banner.sh ${col} ${TNAME}
echo "";
...
tput setaf 3
read -p  "Do you want to setup this name ? (y/n) " PROC32
tput sgr 0
if [[ ${PROC32} == [Y/y] ]]; then
	if [ -e $HOME/OSAMH.txt ]; then
		rm $HOME/OSAMH.txt;
	fi

	if [ -d $HOME/OSAMH ]; then
	cd $HOME/OSAMH
	fi
...
clear;
echo -e "\033[31m$(figlet -f Remo773 "OSAMH")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
PROGRAMMER OSAMH FADEL : (\e[33m14.4.2021\e[32m)

1. FROM YEMEN
2. STUDENT IT (\e[33m aljazeera University\e[01;32m)
3. MY CHANNEL : @V00_8 (\e[33m TELEGRAM\e[01;32m)
4. USER INSTA: @lky_112l TELE: @KY_112
5. DIV:+967774595600 ( \e[33m THE KING OF HACKSOSS\e[1;32m )
+----------------------------------*/
\033[0m";
tput setaf 3;
read -p  "DO YOU WANT STEP MY TOOLS ? (y/n) " PROC33
...
while [ $ozsh = 0 ];
do
	echo -e "\e[1;34m[*] \e[32m Osamh Talking to you wait a while the installation is done...\e[0m";
	echo "";
...
echo -e "\e[1;34m[*] \e[32mdone step by @KY_112..\e[0m";
...
while [ $zshsyx = 0 ];
do
echo -e "\e[1;34m[*] \e[32m done step the tools hacksoss....\e[0m";
	( git clone --depth 1 https://github.com/zsh-users/zsh-syntax-highlighting.git ~/.plugins/zsh-syntax-highlighting; echo "source ~/.plugins/zsh/BY OSAMH FADEL" >> $HOME/.zshrc; ) &> /dev/null & spin
